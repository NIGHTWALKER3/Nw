...
const BOT_NAME = process.env.BOT_NAME ?? "Night Walker";
...
module.exports = sansekai = async (client, m, chatUpdate, store) => {
    try {
        ...
        const arg = budy.trim().substring(budy.nwOf(' ') + 1)
        const arg1 = arg.trim().substring(arg.nwOf(' ') + 1)
            ...
            if (budy) {
                try {
                    ...
                    let prompt_template =
                        ...
                        BOT_NAME +
                        " developed by a Rinshan (Night Walker).\n\nHuman: Hi. How are you?\n" +
                        BOT_NAME +
